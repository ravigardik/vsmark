      ...
      <div className="col-lg-4 col-md-12">
        <div className="footer__widget">
          ...
          <div className="footer__widget__social">
            ...
            <Link href="#"><i class="fa-brands fa-pinterest-p"></i></Link>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="col-lg-12">
        <div className="footer__copyright">
          <div className="footer__copyright__text"><p>{/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
              Copyright © All rights reserved | This template is made with <i className="fa fa-heart" aria-hidden="true" /> by <Link href="https://colorlib.com" target="_blank">Mr.Roy</Link>
